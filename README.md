...
- 两个制造舱可独立选择高级认知载体、高级作战记录或武器检查套组；分别报告三类制造产量、选定培养材料类别和线索结果。
...
- 制造按满级舱室和公开产品时长计算：高级认知载体为 24:26:40，高级作战记录与武器检查套组均为 09:46:40。两个制造舱各自固定所选配方；选择相同配方时合并日产量。
...
测试覆盖稳定周期启动轴、连续心情跟踪、跨设施唯一分配、固定材料类别、逐舱配方与时长换算、同配方产量合并和线索估算等关键行为。

## 部署

- 国内主站：[EdgeOne Makers](https://endfield-is-dp0gzaz4ler3.edgeone.dev/)
